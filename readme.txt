...
Tags: photo gallery, gallery, album gallery, advanced, custom
...
Gallery one of the most awesome photo gallery for wordpress,responsive beautiful easy powerful Photo Gallery + Video Gallery + Link Gallery + Map Gallery Plugin For WordPress.

== Description ==

Gallery A Responsive Simple Beautiful Easy Powerful WordPress Gallery Plugin With Light Box Style. Create gallery using custom post type and use gallery shortcode to publish your gallery anywhere in WordPress. Photo Gallery + video Gallery + Map Gallery + link Gallery 
...
**Upgrade To Premium Plugin - <a href="http://awplife.com/product/photo-gallery-premium/">Click Here</a>**

**Check Premium Plugin Demo - <a href="http://demo.awplife.com/photo-gallery-premium/">Click Here</a>**
...
* Enhancements: compatible for new version 4.7
* Bug Fix: None
* Additional changes: new feature

Feature Enhancements: Version 0.0.11
* Enhancements: None
* Bug Fix: None
* Additional changes: compatible for new version 4.7
